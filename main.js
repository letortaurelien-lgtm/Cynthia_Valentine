document.addEventListener("DOMContentLoaded", function () {
    ...
    let partnerName = "CYNTHIA"; // Replace with dynamic value
    ...
    yesButton.addEventListener("click", function () {
        questionText.innerHTML = `<span class="partner-name">${partnerName}</span><br><span class="love-text">I love you sooo much baby ❤️</span>`;
